...
public class LRRAutoCont extends AutoMode {	
/*
...
*/
    ...
    public LRRAutoCont() {
        ...
        addSequential(new ParallelTask(Arrays.asList(new FollowPath(Paths.LRRPaths.startToScale, false),
        ...
        addSequential(new ParallelTask(Arrays.asList(new FollowPath(Paths.LRRPaths.scaleToBlock, false),
        ...
        addSequential(new FollowPath(Paths.LRRPaths.blockToSwitch, false));
