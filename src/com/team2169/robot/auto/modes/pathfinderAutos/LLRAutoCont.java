...
public class LLRAutoCont extends AutoMode {
/*
...
*/
    ...
    public LLRAutoCont() {
        ...
        addSequential(new ParallelTask(Arrays.asList(new FollowPath(Paths.LLRPaths.startToSwitch, false),
        ...
        addSequential(new ParallelTask(Arrays.asList(new FollowPath(Paths.LLRPaths.switchToBlock, false),
        ...
        addSequential(new ParallelTask(Arrays.asList(new FollowPath(Paths.LLRPaths.blockToScale, false),
