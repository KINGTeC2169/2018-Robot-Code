...
public class LRLAutoCont extends AutoMode {
/*
...
*/
    ...
    public LRLAutoCont() {
        ...
        addSequential(new ParallelTask(Arrays.asList(new FollowPath(Paths.LRLPaths.startToScale, false),
        ...
        addSequential(new ParallelTask(Arrays.asList(new FollowPath(Paths.LRLPaths.scaleToBlock, false),
        ...
        addSequential(new ParallelTask(Arrays.asList(new FollowPath(Paths.LRLPaths.blockToScale, false),
                new NestedPathTask(Arrays.asList(new IntakeClampAction(),
                        new IntakeIdle(),
