...
public class PIDObject{
	 ...
	 */
	public PIDObject(double p, double i, double d){
		P=p; I=i; D=d;
		checkSigns();
		}
	 ...
	 */
	public PIDObject(double p, double i, double d, double f){
		P=p; I=i; D=d; F=f;
		checkSigns();
		}
	 ...
	 * @see PIDObject#getOutput(actual) <br>
	 * @param setpoint
	 */
